...
$$
Por lo tanto: 
$$h(\mathcal{U}(a,b)) = - \lambda \mbox{e}^{-\lambda x } x( \log(\lambda)-\lambda x)$$
...
Por lo tanto:
$$h(\mathcal{U}(a,b)) =\frac{1}{2} (1+log(2 \pi \sigma^2 ))$$
...
Por lo tanto:
$$h(\mathcal{U}(a,b)) =\frac{2 \log(A \sqrt{A^2-x^2})}{\sqrt{A^2-x^2}}$$
